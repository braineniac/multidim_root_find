...
int five_lin_df (const gsl_vector *x, void *params, gsl_matrix *J) {
...
int five_lin_fdf(const gsl_vector *x, void *params,gsl_vector *f,  gsl_matrix *J) {

	five_lin_f(x,params,f);
	five_lin_df(x,params,J);
