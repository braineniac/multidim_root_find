...
int five_exp_df (const gsl_vector *x, void *params, gsl_matrix * J) {
...
int five_exp_fdf(const gsl_vector * x, void *params,gsl_vector * f, gsl_matrix * J) {
	
	five_exp_f(x, params, f);
	five_exp_df(x,params,J);
