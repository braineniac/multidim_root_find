...
int run_five_f(const gsl_multiroot_fsolver_type *T, double * x_init, struct five_f_params p)
{
	gsl_multiroot_fsolver *s;
...
int main(int argc, char *argv[]) 
{
	...
	struct five_f_params p_five_f = {.a=5.64, .b=-6.32, .c=3.14259, .d=2.78, .e=-8.523};
	...
	//	run_powell(gsl_multiroot_fdfsolver_newton,x_init_powell,  p_powell);
		...
		printf("Running Five with the GSL newton solver!\n");
